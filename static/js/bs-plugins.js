    ...
    i.VERSION = "3.3.7", i.TRANSITION_DURATION = 150, i.DEFAULTS = {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (h) {
                ...
                a = "bottom" == a && d.bottom + c > u.bottom ? "top" : "top" == a && d.top - c < u.top ? "bottom" : "right" == a && d.right + p > u.width ? "left" : "left" == a && d.left - p < u.left ? "right" : a, s.removeClass(f).addClass(a)
            }
